  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-database"></i> Tambah Data Kursus</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <form action="../config/inputCourse.php" method="POST">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputNama" class="form-control" name="nama_course" value="">
                  </div>
                  <div class="form-group">
                    <label for="inputNama">Nama Tutor</label>
                    <select name="nama_tutor" class="form-control custom-select" id="">
                      ...
                      ?>
                        <option><?php echo $d['nama_tutor'] ?></option>
                      <?php } ?>
                    </select>
