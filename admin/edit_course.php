  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-database"></i> Edit Data Course</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        $id = $_GET['id'];
        $data = mysqli_query($koneksi, "select * from course where id_course='$id'");
        while ($d = mysqli_fetch_array($data)) {
        ?>

          <form action="../config/cekEditCourse.php" method="post">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="id_course" value="<?php echo $d['id_course']; ?>">
                      <input type="text" id="inputNama" class="form-control" name="nama_course" value="<?php echo $d['nama_course']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Nama Tutor</label>
                      <input type="text" id="inputProfesi" class="form-control" name=" nama_tutor" value="<?php echo $d['nama_tutor']; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-9 mb-2">
                <a href="tb_course.php" class="btn btn-secondary">Cancel</a>
