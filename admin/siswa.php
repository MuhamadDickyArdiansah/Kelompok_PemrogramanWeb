      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="tb_courses.php" class="nav-link">
                ...
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <td>aktif</td>
                      <td>
                        <a type="button" class="btn btn-info" href="edit_siswa.php"><i class="fa-solid fa-pen"></i> EDIT</a>
                        <a role="button" class="btn btn-danger" href="hapus.php?id=<?php echo $d['idmhs']; ?>" onclick="return confirm('Yakin hapus nama <?php echo $d['nama'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
