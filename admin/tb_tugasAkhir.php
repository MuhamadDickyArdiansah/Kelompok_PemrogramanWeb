        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-cloud-arrow-up"></i> Data Tugas Akhir</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item active">Data Tugas Akhir</li>
              </ol>
            </div>
            <!-- /.col -->
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_tugas.php" class="btn btn-info"><i class="fas fa-plus"></i> Tambah Tugas</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($d['status'] === 'Diproses') { ?>
                              <p class="badge bg-warning "><?php echo $d['status'] ?></p>
                            <?php } else if ($d['status'] === 'Diterima') { ?>
                              <p class="badge bg-primary "><?php echo $d['status'] ?></p>
                            <?php } else { ?>
                              <p class="badge bg-danger "><?php echo $d['status'] ?></p>
                            <?php } ?>
                          </td>
                          <td>
                            <a class="btn btn-info btn-sm" href="edit_tugas.php?id=<?php echo $d['id_tugas']; ?>"><i class="fa-solid fa-pen"></i> EDIT</a>
                            <a class="btn btn-danger btn-sm" href="../config/hapusTugas.php?id=<?php echo $d['id_tugas']; ?>" onclick="return confirm('Yakin hapus nama <?php echo $d['nama_siswa'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
