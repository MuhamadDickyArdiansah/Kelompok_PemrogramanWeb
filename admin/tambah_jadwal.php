  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="tb_jadwal.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-calendar"></i> Tambah Jadwal</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <form action="../config/inputJadwal.php" method="POST">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="inputNama">Hari</label>
                    <select id="inputStatus" class="form-control custom-select" name="hari">
                  ...
                  <div class="form-group">
                    <label for="inputNama">Jam</label>
                    <input type="time" id="inputNama" class="form-control" name="jam" value="">
                  </div>
                  <div class="form-group">
