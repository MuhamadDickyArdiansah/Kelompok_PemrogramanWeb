        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"> <i class="fa-solid fa-calendar-days"></i> Jadwal Kursus</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_Jadwal.php" class="btn btn-info"><i class="fas fa-plus"></i> Tambah Jadwal</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-sm" href="edit_jadwal.php?id=<?php echo $d['id_jadwal']; ?>"><i class="fa-solid fa-pen"></i> EDIT</a>
                            <a class="btn btn-danger btn-sm" href="../config/hapusJadwal.php?id=<?php echo $d['id_jadwal']; ?>" onclick="return confirm('Yakin hapus hari <?php echo $d['hari'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
