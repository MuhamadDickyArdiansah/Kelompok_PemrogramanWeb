            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_Tutor.php" class="btn btn-info"><i class="fas fa-plus"></i> Tambah Tugas</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-sm" href="edit_tutor.php?id=<?php echo $d['id_tugas']; ?>"><i class="fa-solid fa-pen"></i> EDIT</a>
                            <a class="btn btn-danger btn-sm" href="../config/hapusTutor.php?id=<?php echo $d['id_tugas']; ?>" onclick="return confirm('Yakin hapus nama <?php echo $d['nama_siswa'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
