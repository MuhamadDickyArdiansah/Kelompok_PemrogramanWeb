        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/product-chain.png" class="img" width="50px" alt="">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/c4.jpg" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p class="">Product management adalah salah satu fungsi strategi dalam suatu perusahaan yang berhubungan dengan pengembangan dan peluncuran suatu produk bisnis. Biasanya, product management juga menentukan strategi dalam memasarkan suatu produk yang sudah dibuat atau dikembangkannya bahkan juga melakukan pembenahan bisnis.</p>
                  <hr>
                  <h3>Apa yang akan anda pelajari</h3>
                  <div class="learn">
                    <p> <i class="far fa-check-circle"></i> Dasar product management</p>
                    <p> <i class="far fa-check-circle"></i> Strategi</p>
                    <p> <i class="far fa-check-circle"></i> Product lifecycle</p>
                    <p> <i class="far fa-check-circle"></i> Pengembangan produk</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Product Management">
