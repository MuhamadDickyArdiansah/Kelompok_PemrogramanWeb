        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/app-development.png" class="img" width="50px" alt="">
              <h1 class="m-0">Mobile development</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/b2.jpg" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p class="">Mobile Developer adalah mereka yang punya spesialiasi dalam teknologi mobile seperti membuat aplikasi untuk Android Google, iOs Apple, dan platform ponsel Microsoft Windows dikutip dari glints.

                    Menjadi seorang mobile developer tentu bukan pekerjaan yang mudah karena Anda harus menguasai beberapa keahlian dalam pemograman yah.

                    Tentunya banyaknya Bahasa pemograman yang berbeda-beda untuk masing-masing platform menjadi tantangan tersendiri untuk seorang mobile developer.</p>

                  <hr>
                  <h3>Apa yang akan anda pelajari</h3>
                  <div class="learn">
                    <p> <i class="far fa-check-circle"></i> Pengenalan App Develoment</p>
                    <p> <i class="far fa-check-circle"></i> Flutter</p>
                    <p> <i class="far fa-check-circle"></i> Design Pattern</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Mobile Development">
