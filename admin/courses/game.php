        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/game-development.png" class="img" width="50px" alt="">
              <h1 class="m-0">Game development</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/b3.jpg" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p class="">Pengembangan game adalah proses pengembangan perangkat lunak karena video game adalah perangkat lunak dengan seni, suara, dan gameplay. Metode pengembangan perangkat lunak formal sering diabaikan. Game dengan metode pengembangan yang buruk cenderung menghabiskan anggaran dan perkiraan waktu, serta mengandung banyak bug. Perencanaan penting untuk proyek dan tim individu. Pengembangan keseluruhan game tidak sesuai dengan metode siklus hidup perangkat lunak biasa, seperti model air terjun.</p>
                  ...
                  <div class="learn">
                    <p> <i class="far fa-check-circle"></i> C# dan C++</p>
                    <p> <i class="far fa-check-circle"></i> Unity Engine</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Game Development">
