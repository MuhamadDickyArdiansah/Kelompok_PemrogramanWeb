        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/improvement.png" class="img" width="50px" alt="">
              <h1 class="m-0">Front End development</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/b1.jpg" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p class="">Pengembang front-end adalah seseorang yang bekerja pada perangkat lunak, seperti situs web desktop atau seluler, yang berinteraksi dengan pengguna. Secara khusus, pengembang front-end menghabiskan waktu di sisi teknologi yang disentuh dan dilihat pengguna.</p>

                  <p>Front end juga biasa disebut sebagai sisi klien, atau lebih luas lagi, antarmuka pengguna.</p>

                  <p>Sementara banyak orang menggunakan front end untuk menggambarkan pengembangan terkait situs web, itu dapat merujuk ke perangkat lunak apa pun yang berinteraksi dengan pengguna.</p>

                  <hr>
                  <h3>Apa yang akan anda pelajari</h3>
                  <div class="learn">
                    <p> <i class="far fa-check-circle"></i> HTML</p>
                    <p> <i class="far fa-check-circle"></i> CSS</p>
                    <p> <i class="far fa-check-circle"></i> Javascript</p>
                    <p> <i class="far fa-check-circle"></i> Framework CSS dan Javascript</p>
                    <p> <i class="far fa-check-circle"></i> RESTful Services dan APIs</p>
                    <p> <i class="far fa-check-circle"></i> Testing / Debugging</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Front End Development">
