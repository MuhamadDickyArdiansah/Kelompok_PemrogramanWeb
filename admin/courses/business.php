        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/analytics.png" class="img" width="50px" alt="">
              <h1 class="m-0">Business Intelligence</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/c3.jpg" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p class="">Business intelligence (disingkat BI) adalah seperangkat alat analisis berupa informasi bisnis yang digunakan untuk mengkonsolidasi, menganalisis, menyimpan dan mengakses banyak data dalam konteks proses bisnis yang mengarah pada pembuatan keputusan dan tindakan dengan tujuan peningkatan kinerja usaha atau bisnis.</p>

                  <p>Business intelligence memberikan jalan untuk memperoleh pengetahuan yang dibutuhkan untuk membuat keputusan yang baik. Lingkungan business intelligence meliputi semua perkembangan, pengolahan informasi, dan dukungan kegiatan yang dibutuhkan untuk memberikan informasi bisnis yang handal dan sangat relevan dan kemampuan analitis bisnis untuk kegiatan bisnis organisasi dan untuk pengambilan keputusan.</p>

                  <hr>
                  <h3>Apa yang akan anda pelajari</h3>
                  <div class="learn">
                    <p> <i class="far fa-check-circle"></i> Data</p>
                    <p> <i class="far fa-check-circle"></i> Sumber data</p>
                    <p> <i class="far fa-check-circle"></i> Visualisasi data</p>
                    <p> <i class="far fa-check-circle"></i> Arsitektur data</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Business Intelligence">
