        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6 d-flex align-items-center">
              <img src="../../assets/img/backend.png" class="img" width="50px" alt="">
              <h1 class="m-0">Back End development</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              ...
              <div class="card-body">
                <img src="../../assets/img/b4.png" class="img-fluid rounded" alt="">
                ...
                <div class="card-body">
                  ...
                  <p>Backend Developer atau Back End Developer adalah tim dari web developer yang memiliki tugas khusus untuk pengelolaan server, aplikasi serta database sehingga semua bisa berjalan dengan lancar.
                    ...
                    Biasanya bahasa pemrograman yang biasa dipakai para backend developer meliputi PHP, JavaScript, Python, Ruby, SQL dan lainnya.</p>
                  ...
                  <div class="learn">
                    ...
                    <p> <i class="far fa-check-circle"></i> Web Server</p>
                    <p> <i class="far fa-check-circle"></i> Database</p>
                    <p> <i class="far fa-check-circle"></i> Laravel</p>
                    <p> <i class="far fa-check-circle"></i> RESTful Services dan APIs</p>
                    <p> <i class="far fa-check-circle"></i> Git</p>
                  </div>
                </div>
              </div>
              ...
              <div class="small-box bg-light">
                <div class="card-body">
                  <form action="../../config/transaksi/input_frontEnd.php" method="POST">
                    ...
                    <input type="hidden" name="nama_course" value="Back End Development">
