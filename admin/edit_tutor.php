  ...
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="tb_tutor.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tutor</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-user-pen"></i> Edit Data Tutor</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        $id = $_GET['id'];
        $data = mysqli_query($koneksi, "select * from tutor where id_tutor='$id'");
        while ($d = mysqli_fetch_array($data)) {
        ?>

          <form action="../config/cekEditTutor.php" method="post">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="id_tutor" value="<?php echo $d['id_tutor']; ?>">
                      <input type="text" id="inputNama" class="form-control" name="nama_tutor" value="<?php echo $d['nama_tutor']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Profesi</label>
                      <input type="text" id="inputProfesi" class="form-control" name="profesi" value="<?php echo $d['profesi']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputPassword">Email</label>
                      <input type="text" id="inputPassword" class="form-control" name="email" value="<?php echo $d['email']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputEmail">Password</label>
                      <input type="password" id="inputEmail" class="form-control" name="password" value="<?php echo $d['password']; ?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="row justify-content-center">
              <div class="col-md-9 mb-2">
                <a href="tb_siswa.php" class="btn btn-secondary">Cancel</a>
