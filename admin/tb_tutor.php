        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-chalkboard-user"></i> Data Tutor</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_Tutor.php" class="btn btn-info"><i class="fas fa-plus"></i> Tambah Tutor</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-sm" href="edit_tutor.php?id=<?php echo $d['id_tutor']; ?>"><i class="fa-solid fa-pen"></i> EDIT</a>
                            <a class="btn btn-danger btn-sm" href="../config/hapusTutor.php?id=<?php echo $d['id_tutor']; ?>" onclick="return confirm('Yakin hapus nama <?php echo $d['nama_tutor'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
