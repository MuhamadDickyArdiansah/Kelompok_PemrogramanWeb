  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-user-pen"></i> Tambah Data Tutor</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <form action="../config/inputTutor.php" method="POST">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputNama" class="form-control" name="nama_tutor" value="">
                  </div>
                  <div class="form-group">
                    <label for="inputNama">Profesi</label>
                    <input type="text" id="inputProfesi" class="form-control" name="profesi" value="">
                  </div>
                  <div class="form-group">
