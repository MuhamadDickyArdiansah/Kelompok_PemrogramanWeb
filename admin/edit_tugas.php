  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        $id = $_GET['id'];
        $data = mysqli_query($koneksi, "select * from tugas where id_tugas='$id'");
        while ($d = mysqli_fetch_array($data)) {
        ?>

          <form action="../config/cekEditTugas.php" method="post">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="inputNama" class="form-control" name="nama_siswa" value="<?php echo $d['nama_siswa'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Nama Course</label>
                      <input type="text" id="inputNama" class="form-control" name="nama_course" value="<?php echo $d['nama_course'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Nama Tugas</label>
                      <input type="text" id="inputProfesi" class="form-control" name="nama_tugas" value="<?php echo $d['nama_tugas'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Nilai</label>
                      <input type="number" id="inputProfesi" class="form-control" name="nilai" value="<?php echo $d['nilai'] ?>">
                    </div>
                    <div class="form-group">
