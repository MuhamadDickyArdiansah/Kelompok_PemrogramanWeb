    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-calendar"></i> Edit Jadwal</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        ?>
          ...
          <form action="../config/cekEditJadwal.php" method="post">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select id="inputHari" class="form-control custom-select" name="hari">
                    ...
                    <div class="form-group">
                      ...
                      <input type="time" id="inputNama" class="form-control" name="jam" value="<?php echo $d['jam']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="inputNama">Nama Course</label>
                      <input type="text" id="inputProfesi" class="form-control" name="nama_course" value="<?php echo $d['nama_course']; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-9 mb-2">
                <a href="tb_jadwal.php" class="btn btn-secondary">Cancel</a>
                <input name="edit" type="submit" value="Save Changes" class="btn btn-success float-right">
              </div>
            </div>
          </form>
        <?php }
