        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="tb_siswa.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Siswa</p>
                  </a>
                </li>
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-users"></i> Data Siswa</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_siswa.php" class="btn btn-info"><i class="fas fa-plus"></i> Tambah Siswa</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-sm" href="edit_siswa.php?id=<?php echo $d['id_siswa']; ?>"><i class="fa-solid fa-pen"></i> EDIT</a>
                            <a class="btn btn-danger btn-sm" href="../config/hapusSiswa.php?id=<?php echo $d['id_siswa']; ?>" onclick="return confirm('Yakin hapus nama <?php echo $d['nama'] ?> ?');"><i class="fa-solid fa-trash"></i> HAPUS</a>
