  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-user-pen"></i> Tambah Data Siswa</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <form action="../config/inputUser.php" method="POST">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputNama" class="form-control" name="nama" value="">
                  </div>
                  <div class="form-group">
