  ...
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="tb_tugasAkhir.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <h1 class="m-0"><i class="fa-solid fa-user-pen"></i> Tambah Data Tugas</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <form action="../config/inputTugas.php" method="POST">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <input type="text" id="inputNama" class="form-control" name="nama_siswa" value="">
                  </div> -->
                  <div class="form-group">
                    <label for="inputNama">Nama Siswa</label>
                    <select name="nama_siswa" class="form-control custom-select" id="">
                      <option disabled selected>Masukkan Nama</option>
                    ...
                    <!-- <input type="text" id="inputProfesi" class="form-control" name=" nama_tutor" value=""> -->
                  </div>

                  <!-- <div class="form-group">
                    <label for="inputEmail">Nama Course</label>
                    <input type="text" id="inputEmail" class="form-control" name="nama_course" value="">
                  </div> -->
                  <div class="form-group">
                    <label for="inputNama">Nama Course</label>
                    <select name="nama_course" class="form-control custom-select" id="">
                      <option disabled selected>Masukkan Course</option>
                      ...
                      while ($d = mysqli_fetch_array($data)) {
                      ?>
                        <option><?php echo $d['nama_course'] ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="form-group">
                    <label for="inputPassword">Nama Tugas</label>
                    <input type="text" id="inputPassword" class="form-control" name="nama_tugas" value="">
                  </div>
                  <div class="form-group">
                    <label for="inputGender">nilai</label>
                    <input type="text" id="inputPassword" class="form-control" name="nilai" value="">
          ...
          <div class="row justify-content-center">
            <div class="col-md-9 mb-2">
              <a href="tb_tugasAkhir.php" class="btn btn-secondary">Cancel</a>
